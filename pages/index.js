...
import { abi, CRYPTODEV_NFT_CONTRACT_ADDRESS } from "../constants";
...
export default function Home() {
   ...
   const startPresale = async () => {
      try {
         ...
         const cryptoDevsContract = new Contract(CRYPTODEV_NFT_CONTRACT_ADDRESS, abi, signer);
   ...
   const checkIfPresaleStarted = async () => {
      try {
         ...
         const cryptoDevsContract = new Contract(CRYPTODEV_NFT_CONTRACT_ADDRESS, abi, provider);
   ...
   const checkIfPresaleEnded = async () => {
      try {
         const provider = await getProviderOrSigner();
         const cryptoDevsContract = new Contract(CRYPTODEV_NFT_CONTRACT_ADDRESS, abi, provider);
         const _presaleEnded = await cryptoDevsContract.persaleEnded();
